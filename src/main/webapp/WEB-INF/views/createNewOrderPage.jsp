    ...
    <div style="width: 100% ;height:60%">
        <main class="form-signin">
            ...
            <form:form modelAttribute="newOrder" method="post" action="/order/createOrder">
                ...
                <div class="form-floating">
                    <form:input type="date" class="form-control" id="floatingPassword" path="dateOfWork"
                                name="dateOfWork"/>
                ...
                <form:select path="subService.name">
                    <form:option value="NONE" label="---Select sub service---"/>
...
<%--                <a href="/mapp">Select Your Location</a>--%>
    ...
    <div  style="width: 100%;height: 40%;"  id="app">
<%--        <form action="#">--%>
