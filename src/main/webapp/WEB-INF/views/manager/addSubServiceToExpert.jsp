...
<html lang="en">
<head>
    <title>ad_sub_service_to_expert</title>
    <meta charset="utf-8">
...
<div style="text-align: left">
    <main id="sideBar">
        ...
        <div id="aliginleft" class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 250px">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="/user/searchUser" class="nav-link link-dark">
                        <svg class="bi me-2" width="16" height="16">
                ...
                <li>
                    <a href="/managerPage/orderHistoryPage" class="nav-link link-dark">
                        <svg class="bi me-2" width="16" height="16">
                            <use xlink:href="#table"/>
                        </svg>
                        Filter Orders
                ...
                <li>
                    <a href="/managerPage/filterUserBaseOnNumOfOrders" class="nav-link link-dark">
                        <svg class="bi me-2" width="16" height="16">
                            <use xlink:href="#table"/>
                        </svg>
                        Filter User Base On Number Of Orders
                    </a>
                </li>

                <li>
                    <a href="/service/addNewService" class="nav-link link-dark">
                        <svg class="bi me-2" width="16" height="16">
                            <use xlink:href="#table"/>
                        </svg>
                        Add New Service
                ...
                <li>
                    <a href="/subService/addNewSubService" class="nav-link link-dark">
                        <svg class="bi me-2" width="16" height="16">
                            <use xlink:href="#table"/>
                        </svg>
                        Add New Sub Service
